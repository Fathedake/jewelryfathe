export default function Success1Icon({width,height}:{width:number,height:number}){

    return <>
    
    <div>
    <div className="css-12utgez eu4oa1w0">
      <div className="css-7y694t eu4oa1w0">
        <svg
        ...
        >
          <defs>
            <linearGradient
              id="spot-thanks-2_svg__spot-thanks-2__paint0_linear"
              x1="84.283"
              x2="68.594"
              y1="23.296"
              y2="30.717"
            ...
            >
              <stop stop-color="#B4602B"></stop>
              <stop offset="0.344" stop-color="#89471E"></stop>
              <stop offset="0.958" stop-color="#623721"></stop>
            </linearGradient>
            <linearGradient
              id="spot-thanks-2_svg__spot-thanks-2__paint1_linear"
              x1="82.379"
              x2="75.298"
              y1="24.116"
              y2="27.935"
              gradientUnits="userSpaceOnUse"
            >
              <stop offset="0.39" stop-color="#89471E"></stop>
              <stop offset="1" stop-color="#623721"></stop>
            </linearGradient>
            <linearGradient
              id="spot-thanks-2_svg__spot-thanks-2__paint2_linear"
              x1="108.999"
              x2="65.128"
              y1="26.885"
              y2="80.553"
            ...
            >
              <stop stop-color="#B4602B"></stop>
              <stop offset="0.477" stop-color="#89471E"></stop>
              <stop offset="0.943" stop-color="#623721"></stop>
            </linearGradient>
            <linearGradient
              id="spot-thanks-2_svg__spot-thanks-2__paint3_linear"
              x1="117.093"
              x2="81.433"
              y1="27.737"
              y2="45.786"
            ...
            >
              <stop stop-color="#B4602B"></stop>
              <stop offset="0.546" stop-color="#89471E"></stop>
              <stop offset="0.877" stop-color="#623721"></stop>
            </linearGradient>
            <filter
              id="spot-thanks-2_svg__spot-thanks-2__filter0_d"
              width="22.834"
              height="35.915"
              x="66.217"
              y="23.265"
            ...
            <filter
              id="spot-thanks-2_svg__spot-thanks-2__filter1_d"
              width="71.88"
              height="58.1"
              x="42.041"
              y="40.036"
            ...
            <filter
              id="spot-thanks-2_svg__spot-thanks-2__filter2_d"
              width="17.771"
              height="25.18"
              x="57.752"
              y="61.042"
            ...
            <filter
              id="spot-thanks-2_svg__spot-thanks-2__filter3_d"
              width="47.462"
              height="23.775"
              x="16.936"
              y="79.225"
            ...
            <clipPath id="spot-thanks-2_svg__spot-thanks-2__svgClip">
              <path
                xmlns="http://www.w3.org/2000/svg"
                id="spot-thanks-2_svg__spot-thanks-2__Mask"
                fill="#fff"
                d="M29.112 87.68l-8.61-62.583c6.864-.585 18.856-.915 24.441 3.126 4.554 3.295 5.5 7.229 6.61 11.836.51 2.118 1.053 4.379 1.998 6.784 2.436 6.208 9.814 6.653 14.393 6.66l.401-.855a38.025 38.025 0 017.712-10.02 3.987 3.987 0 001.192-2.111l1.928-9.25-.024-.127-.012.004-.368-1.949-.666-3.418a2.106 2.106 0 012.29-2.5 4.663 4.663 0 013.722 2.64l1.26 2.653a13.04 13.04 0 011.24 4.837l.432 7.399a10.43 10.43 0 015.094-.705l16.032 1.79a2.71 2.71 0 012.458 3.462l-.872 3.013a2.17 2.17 0 00.178 1.627l.019.034c.024.043.048.087.073.127l1.338 2.042a3.37 3.37 0 01-.768 4.522l-1.708 2.377-.27 2.221a7.538 7.538 0 01-4.135 5.84l-.623.309.291 1.977c.113.798.025 1.372-.19 1.853l.083-.107c-.058.09-.122.175-.19.256l-.095.12-.058.062-.95 1.215c-1.427 1.502-3.118 2.254-5.188 2.206l-2.495.006c3.212 2.933 7.531 4.638 17.72 3.987 11.79-.751 16.464 3.61 20.27 21.957H59.611l-.002.003H16.935s1.994-9.883 4.75-8.378c1.239.677 2.985-.95 4.896-2.73.822-.766 1.675-1.56 2.53-2.212z"
              ></path>
            </clipPath>
            <pattern
              id="spot-thanks-2_svg__spot-thanks-2__texture"
              width="38"
              height="32"
              x="0"
              y="0"
          ...
          <g
            id="spot-thanks-2_svg__spot-thanks-2__Group"
            clip-path="url(#spot-thanks-2_svg__spot-thanks-2__svgClip)"
          >
            <path
              id="spot-thanks-2_svg__spot-thanks-2__Vector"
              fill="#B1ABF4"
              d="M133.065 100.997c-3.806-18.347-8.48-22.708-20.27-21.957-12.41.793-16.112-1.909-19.713-6.068-4.511-5.213-2.456-7.523-6.676-12.974-4.524-5.843-8.807-6.421-16.192-6.502-3.838-.041-13.76.745-16.663-6.653-2.999-7.639-1.96-13.81-8.608-18.62-5.585-4.04-17.577-3.711-24.44-3.126l10.44 75.9h102.122z"
            ></path>
            <g
              id="spot-thanks-2_svg__spot-thanks-2__Subtract"
              filter="url(#spot-thanks-2_svg__spot-thanks-2__filter0_d)"
            >
              <path
                fill="url(#spot-thanks-2_svg__spot-thanks-2__paint0_linear)"
                d="M66.217 57.18l13.109-11.94 6.344-3.75c.445-.263.906-.491 1.38-.684l-.43-7.4a13.04 13.04 0 00-1.24-4.836l-1.261-2.654a4.663 4.663 0 00-3.723-2.639 2.106 2.106 0 00-2.29 2.5l1.071 5.49-1.928 9.25a3.986 3.986 0 01-1.192 2.11 38.024 38.024 0 00-7.712 10.02l-2.128 4.533z"
              ></path>
            </g>
            <path
              id="spot-thanks-2_svg__spot-thanks-2__Subtract_2"
              fill="url(#spot-thanks-2_svg__spot-thanks-2__paint1_linear)"
              d="M79.2 45.355l2.365-5.414a23.361 23.361 0 001.05-15.768c.6.449 1.095 1.04 1.427 1.74l1.26 2.654a13.04 13.04 0 011.24 4.836l.434 7.434c-.448.186-.884.404-1.306.653l-6.344 3.75-.127.115z"
            ></path>
            <g
              id="spot-thanks-2_svg__spot-thanks-2__Subtract_3"
              filter="url(#spot-thanks-2_svg__spot-thanks-2__filter1_d)"
            >
              <path
                fill="url(#spot-thanks-2_svg__spot-thanks-2__paint2_linear)"
                d="M110.033 50.153l1.337 2.043a3.357 3.357 0 01-.774 4.516l-1.708 2.378-.27 2.22a7.536 7.536 0 01-4.135 5.84l-.623.309.291 1.977c.116.816.021 1.398-.205 1.885l-.121.157.225-.29a2.772 2.772 0 01-.29.37l-1.003 1.283c-1.427 1.502-3.117 2.254-5.188 2.206l-3.496.009-6.62 2.574a15.484 15.484 0 01-8.866.698 5.949 5.949 0 00-6.205 2.517L62.303 95.311c-10.577 5.191-20.128-15.787-20.262-16.083L79.325 45.24l6.345-3.75a10.43 10.43 0 016.475-1.389l16.031 1.79a2.711 2.711 0 012.459 3.462l-.872 3.013a2.171 2.171 0 00.196 1.661c.024.043.048.087.074.126z"
              ></path>
            </g>
            <path
              id="spot-thanks-2_svg__spot-thanks-2__Vector_2"
              fill="#F9A77F"
              d="M78.12 25.729s.13-.689 1.722-.522c0 0 .75 5.442-.701 5.937l-1.022-5.415z"
            ></path>
            <path
              id="spot-thanks-2_svg__spot-thanks-2__Vector_3"
              fill="url(#spot-thanks-2_svg__spot-thanks-2__paint3_linear)"
              d="M111.372 52.196l-1.338-2.043c-.033-.05-.062-.106-.092-.16-1.471-.451-6.798-2.081-6.857-2.108-1.083-.493-2.095.826-2.32 1.749-.371 1.517.884 2.83.819 4.409-.074 1.793-1.359 3.393-1.323 5.189.047 2.577 1.45 4.513-.528 6.787-1.433 1.647-3.806 2.39-5.932 2.404l7.13 3.884a2.71 2.71 0 002.836-.743l.187-.237c.225-.487.32-1.069.204-1.885l-.29-1.977.622-.31a7.536 7.536 0 004.135-5.839l.27-2.22 1.708-2.378a3.37 3.37 0 00.769-4.522z"
            ></path>
            <g
              id="spot-thanks-2_svg__spot-thanks-2__Vector_4"
              filter="url(#spot-thanks-2_svg__spot-thanks-2__filter2_d)"
            >
              <path
                fill="#002B3C"
                d="M61.675 61.08c.135-.095.326-.002.32.158-.03.973.281 3.661 3.67 8.386.966 1.348 4.689 7.905 7.512 9.885.39.276.46.81.16 1.175l-2.483 3.065a1.313 1.313 0 01-1.837.18c-1.537-1.254-4.558-4.233-7.904-10.29-4.82-8.724-3.04-9.99-3.04-9.99l3.602-2.569z"
              ></path>
            </g>
            <path
              id="spot-thanks-2_svg__spot-thanks-2__Vector_5"
              fill="#fff"
              d="M66.072 77.466c2.687-1.064 3.778-4.678 2.437-8.072-1.341-3.394-4.607-5.283-7.294-4.22-2.687 1.065-3.778 4.678-2.437 8.072 1.341 3.394 4.607 5.283 7.294 4.22z"
            ></path>
            <path
              id="spot-thanks-2_svg__spot-thanks-2__Vector_(Stroke)"
              fill="#B1ABF4"
              fill-rule="evenodd"
              d="M61.341 65.296c-2.61.983-3.823 4.297-2.645 7.433 1.179 3.137 4.272 4.831 6.883 3.848 2.61-.982 3.823-4.296 2.645-7.433-1.178-3.137-4.272-4.83-6.883-3.848zM58.43 72.83c-1.217-3.242.014-6.748 2.812-7.801s6.032.773 7.25 4.015c1.218 3.241-.013 6.748-2.812 7.8-2.798 1.054-6.032-.772-7.25-4.014z"
              clip-rule="evenodd"
            ></path>
            <path
              id="spot-thanks-2_svg__spot-thanks-2__Vector_6"
              fill="#B1ABF4"
              d="M67.785 67.987a8.079 8.079 0 01.86 3.64c-.024 3.506-2.477 5.872-5.478 5.282-1.647-.324-3.112-1.47-4.102-3.017.958 1.927 2.627 3.405 4.535 3.78 3.001.59 5.454-1.776 5.478-5.282.015-1.585-.478-3.13-1.293-4.403z"
            ></path>
            <g
              id="spot-thanks-2_svg__spot-thanks-2__Vector_7"
              filter="url(#spot-thanks-2_svg__spot-thanks-2__filter3_d)"
            >
              <path
                fill="#164081"
                d="M42.04 79.225s9.668 21.439 20.357 16.04L59.61 101H16.935s1.994-9.883 4.75-8.378c2.755 1.505 8.016-8.378 12.024-6.018l8.331-7.38z"
              ></path>
            </g>
            <path
              fill="url(#spot-thanks-2_svg__spot-thanks-2__texture)"
              d="M29.112 87.68l-8.61-62.583c6.864-.585 18.856-.915 24.441 3.126 4.554 3.295 5.5 7.229 6.61 11.836.51 2.118 1.053 4.379 1.998 6.784 2.436 6.208 9.814 6.653 14.393 6.66l.401-.855a38.025 38.025 0 017.712-10.02 3.987 3.987 0 001.192-2.111l1.928-9.25-.024-.127-.012.004-.368-1.949-.666-3.418a2.106 2.106 0 012.29-2.5 4.663 4.663 0 013.722 2.64l1.26 2.653a13.04 13.04 0 011.24 4.837l.432 7.399a10.43 10.43 0 015.094-.705l16.032 1.79a2.71 2.71 0 012.458 3.462l-.872 3.013a2.17 2.17 0 00.178 1.627l.019.034c.024.043.048.087.073.127l1.338 2.042a3.37 3.37 0 01-.768 4.522l-1.708 2.377-.27 2.221a7.538 7.538 0 01-4.135 5.84l-.623.309.291 1.977c.113.798.025 1.372-.19 1.853l.083-.107c-.058.09-.122.175-.19.256l-.095.12-.058.062-.95 1.215c-1.427 1.502-3.118 2.254-5.188 2.206l-2.495.006c3.212 2.933 7.531 4.638 17.72 3.987 11.79-.751 16.464 3.61 20.27 21.957H59.611l-.002.003H16.935s1.994-9.883 4.75-8.378c1.239.677 2.985-.95 4.896-2.73.822-.766 1.675-1.56 2.53-2.212z"
