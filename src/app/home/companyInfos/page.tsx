...
export default async function CompanyInfosPage() {
    ...
    return <>
        <div className="">
            ...
            >
                <div className="px-14 leading-9" style={{ marginTop: '20px', marginBottom: '50px', fontSize: '18px' }}>
                <Meta
                    title={<h1 className="font-bold text-xl">Qui sommes-nous ?</h1>}
                />
                    <p className="">
                    ...
                    <h2  className="font-bold text-xl">Notre mission</h2>
                    <p>
                    ...
                    <h2 className="font-bold text-xl">Notre histoire</h2>
                    <p>
                    ...
                    <h2  className="font-bold text-xl">Notre engagement</h2>
                    <p>
                    ...
                    <h2  className="font-bold text-xl">Notre vision</h2>
                    <p>
