    ...
    <ConfigProvider theme={{
      ...
      <div className="w-full">
        <div className="add-to-cart-box flex items-center justify-center w-full">
          ...
          <div className="ms-2 w-full py-4">
            <Button disabled={quantity == 0 ? true : false} className="bg-doree text-white" block size="large" onClick={async () => {
              await dispatch(addToCart({ product, quantity })); openNotificationInfo("Succès de l'opération", "Vous venez d'ajouter un produit au panier avec succès");
            }}>
